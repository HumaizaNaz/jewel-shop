  ...
  {sortedProducts.map((product) => (
    ...
    >
      ...
      <div className="p-4 flex flex-col flex-grow">
        <h3 className="text-xl font-semibold text-orange-950 truncate">{product.name}</h3>
        <p className="text-lg font-medium text-orange-600 mb-4">${product.price}</p>

        <div className="mt-auto">
          <Link href={`/product/${product.id}`} passHref>
            <button className="w-full bg-gradient-to-r from-orange-800 to-orange-950 text-white py-2 rounded-lg shadow-md hover:bg-orange-500 transition-all duration-300">
              View Details
            </button>
          </Link>
        </div>
