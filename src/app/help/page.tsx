...
const Help = () => {
  return (
    <div className="py-16 px-6 sm:px-10 lg:px-20 min-h-screen">
      <div className="max-w-screen-xl mx-auto text-center text-orange-950">
        <h2 className="text-4xl sm:text-5xl font-bold tracking-tight mb-4">
          Need Assistance with Your Gold Aura Experience?
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {/* FAQ Section */}
          <div className="bg-gradient-to-r from-orange-800 to-orange-950 text-white p-8 rounded-2xl shadow-xl transform hover:scale-105 transition-transform">
            ...
            <a
              href="/faq"
              className="inline-block bg-white text-orange-950 hover:bg-gray-200 py-2 px-6 rounded-full font-semibold transition-all"
            >
              Explore FAQs
            </a>
          </div>
        ...
        <div className="mt-16 bg-white text-center p-8 rounded-xl shadow-lg transform hover:scale-105 transition-transform">
          ...
          <a
            href="/Contact"
            className="inline-block px-8 py-4 bg-gradient-to-r from-orange-800 to-orange-950 hover:bg-orange-400 text-white rounded-xl text-xl font-semibold transition-all transform hover:scale-105"
          >
            Get in Touch
          </a>
        </div>
