        ...
        />
          ...
          <div className="bg-white p-6 rounded-lg shadow-md mt-8">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-orange-800 to-orange-950 text-white py-3 px-8 rounded-lg shadow-md hover:bg-orange-700 transition-all duration-300"
            >
