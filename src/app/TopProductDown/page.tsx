...
export default function VipSection() {
  ...
  return (
    <section
      className="relative bg-gradient-to-br from-red-900 via-orange-950 to-orange-900 text-white py-20"
    >
      ...
      <div className="relative z-10 text-center px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white bg-opacity-10 p-6 rounded-lg shadow-xl text-center">
            <div className="mb-6 text-4xl text-orange-200">
        ...
        <div className="mt-6">
          <button
            ...
            className="px-8 py-4 border-2 border-white bg-gradient-to-r from-orange-800 to-orange-950 text-white rounded-lg text-lg font-semibold shadow-xl hover:scale-105 transition-transform"
          >
